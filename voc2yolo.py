...
if __name__ == '__main__':
    ...
    config ={
        ...
        "output_path": args.convert_output_path + '/labels/',
        "cls_list": args.cls_list_file,
    }

    if os.path.exists(args.convert_output_path + '/labels'):
        pass
    else:
        os.mkdir(args.convert_output_path + '/labels')

    if os.path.exists(args.convert_output_path + '/images'):
        pass
    else:
        os.mkdir(args.convert_output_path + '/images')

    print('image copy start!')
    #copy_tree(args.img_path, args.convert_output_path+'/images')
    print('copy finished!')
